<div class="p-4 rounded max-w-lg xl:max-w-xl border" x-cloak x-show="ready">
    ...
    <div id="preview-toolbar" class="toolbar flex justify-end mb-2">
        <x-button type="button" x-bind:disabled="refreshingPreview" x-on:click="printTicket()" icon="printer" variant="purple" :outline="true" aria-label="Imprimir ticket"></x-button>
    </div>
