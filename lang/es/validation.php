...
return [
    ...
    'attributes' => [
        'morning_slots' => 'huecos mañanas',
        'afternoon_slots' => 'huecos tardes',
        'closing_date' => 'cierre',
        'student_number' => 'número de estudiante',
        'degree_id' => 'titulación',
    ...
    'different_from_current_password' => 'El campo :attribute debe ser diferente de la contraseña actual.',
    ...
    'exists_with_foreign_keys' => 'El campo :attribute tiene dependencias no satisfechas con otros campos.',
    ...
    'not_exists_with_foreign_keys' => 'El campo :attribute ya existe para el mismo valor de :foreign_key.',
